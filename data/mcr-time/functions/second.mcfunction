...
execute if score #mcr_time mcr_time matches 1000..13999 run function mcr-gameplay:sunrise
execute unless score #mcr_time mcr_time matches 1000..13999 run function mcr-gameplay:sunset